...
},interval=timer(),minus=document.getElementById("-"),plus=document.getElementById("+"),heart=document.getElementById("<3"),pause=document.getElementById("pause"),commentForm=document.getElementsByTagName("form")[0];
